...
public enum PayloadType {
       ...
       RESET_TURN, // trigger to tell client to reset their local list turn status
        START_ROUND, // trigger to start a new round in a GameRoom
        PICK, // example of picking an item in a turn
        TIME,      //example of a time event in a turn
        POINTS, // example of a points event in a turn
        USER_LIST_UPDATE, // update the user list in the UI
       EXAMPLE_TURN// example of taking a turn and syncing a turn action
}